...
// À mettre dans le .h. Pour les variables, certains compilateurs
// râlent si on n'ajoute pas "extern" devant. D'autres râlent si on
// met "extern"...
//
///////////////////////////////////////////////////////////////////////////
      ...
      if (e.button.button == SDL_BUTTON_LEFT) {
        ...
        if (hover) {
          ...
          if ((x - vertices[v].x)*(x - vertices[v].x) +
              (y - vertices[v].y)*(y - vertices[v].y) < (sizePt*sizePt)+2 )
            selectedVertex = v;
        }
        mouse_ldown = true;
      }
